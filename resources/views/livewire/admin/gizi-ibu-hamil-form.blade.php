<div class="ibox-content">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input type="text" placeholder="Masukan tinggi badan (cm)" wire:model.lazy="tinggi_badan"
                class="form-control">
            @error('tinggi_badan')
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input type="text" placeholder="Masukan berat badan (kg)" wire:model.lazy="berat_badan"
                class="form-control">
            @error('berat_badan')
